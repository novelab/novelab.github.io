...
$('#3D_scanning_video').css('display','none');
	...
	$('.overlay-close').click(function(){
		...
		$('#3D_scanning_video').css('display','none');
		video = $('#3D_scanning_video').attr("src");
		...
		$('#holyshield_vimeo').css('display','none');
		video = $('#holyshield_vimeo').attr("src");
				$('#holyshield_vimeo').attr("src","");
				$('#holyshield_vimeo').attr("src",video);
		...
		$('#VRVideoPlayerBiotherm_view').css('visibility','hidden');
		$('#VRVideoPlayerBiotherm_video').css('display','none');
		video = $('#VRVideoPlayerBiotherm_video').attr("src");
				$('#VRVideoPlayerBiotherm_video').attr("src","");
				$('#VRVideoPlayerBiotherm_video').attr("src",video);
	})
	...
	<!-- To quit the pop-up and reactivate the scroll -->
		...
		<!-- To activate the pop-up and desactivate the global the scroll -->	
	$('#VRVideoPlayerBiotherm').click(function(){
			$('#VRVideoPlayerBiotherm_view').css('visibility', 'visible');
			$('body').css('overflow', 'hidden');
			$('#VRVideoPlayerBiotherm_video').css('display','inline');
			$('#VRVideoPlayerBiotherm_view').find('.articles').scrollTop(0);
				$('#cardboard_view').css('visibility', 'hidden');
				$('#typerider_view').css('visibility', 'hidden');
				$('#parvis_view').css('visibility', 'hidden');
				$('#oculus_view').css('visibility', 'hidden');
	...
	<!-- To quit the pop-up and reactivate the scroll -->
		$('#VRVideoPlayerBiotherm_view').click(function(event){
					if($(event.target).attr('id') == 'VRVideoPlayerBiotherm_view'){
						video = $('#VRVideoPlayerBiotherm_video').attr("src");
						$('#VRVideoPlayerBiotherm_video').attr("src","");
						$('#VRVideoPlayerBiotherm_video').attr("src",video);
						$('#VRVideoPlayerBiotherm_video').css('display','none');
